...
def show_message_box(
    ...
    Warning and critical messages have the support contact line appended so
    users always know how to reach support when something goes wrong. This
    helper is intentionally defensive to avoid raising during startup when
    the application or UI may not yet be initialized.
    """
    try:
