...
class FusionWebSocketClient:
    ...
    async def _connect(self) -> None:
        try:
            ...
            # Relax the ping timers so Fusion 360 doesn't disconnect while the AI is thinking
            self._websocket = await websockets.connect(self._url, ping_interval=120, ping_timeout=120)
